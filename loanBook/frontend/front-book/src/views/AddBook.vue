      ...
      <form @submit.prevent="submitForm" enctype="multipart/form-data">
        ...
        <div class="row col-12" style="line-height: 2;" id="form_add_book">
          ...
          <div class="col-6">
            ...
            <input type="date" v-model="year_publication" class="form-control" aria-label="year of publication" id="year_publication" name="year_publication">
          ...
          <div class="col-12">
            ...
            <select class="form-control" v-model="type_book" aria-label="type_book" id="type_book" name="type_book" @change="showFileInput">
          ...
          <div class="col-12">
            ...
            <textarea  id="" v-model="description" cols="30" rows="3" class="form-control">Enter some description</textarea>
          ...
          <button type="submit" class="btn btn-outline-primary" style="margin-top: 1em;width: 100%;">Add book</button>
        </div>
      </form>
    </div>
    ...
    async submitForm(){
      ...
      try {
        if(this.isValidForm()){
          ...
          this.successMessage = "Book add with success😎"
